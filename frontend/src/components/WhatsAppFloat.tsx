...
export default function WhatsAppFloat() {
  ...
  return (
    <a
      ...
      className="whatsapp-float fixed z-40 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-[8px_8px_20px_rgba(163,177,198,0.55),-6px_-6px_16px_rgba(255,255,255,0.8)] transition hover:scale-105 hover:brightness-95"
    >
